...
import huaiye.com.vvs.map.baidu.clusterutil.MarkerManager;
import huaiye.com.vvs.map.baidu.clusterutil.clustering.algo.Algorithm;
import huaiye.com.vvs.map.baidu.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import huaiye.com.vvs.map.baidu.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import huaiye.com.vvs.map.baidu.clusterutil.clustering.view.ClusterRenderer;
import huaiye.com.vvs.map.baidu.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onMapStatusChange(MapStatus mapStatus) {
        ...
        if (position != null && mPreviousCameraPosition != null && mPreviousCameraPosition.zoom == position.zoom) {
            return;
        }

...
import huaiye.com.vvs.map.baidu.LocationStrategy;
 ...
 * 长时间不动10,20,30秒定位一次
 */
public class LocationStrategyMiddleImp extends LocationStrategy {
    ...
    protected boolean checkNeedSleep() {
        ...
        Logger.debug(LocationService.TAG,"LocationStrategyMiddleImp dis  " + dis);
        //小于5米认为没有移动
        if (dis < 5){
            sameLocationCount++;
        }else {

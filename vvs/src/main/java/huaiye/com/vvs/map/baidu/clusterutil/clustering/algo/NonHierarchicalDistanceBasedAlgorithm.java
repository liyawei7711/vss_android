...
import huaiye.com.vvs.map.baidu.clusterutil.projection.Bounds;
...
import huaiye.com.vvs.map.baidu.clusterutil.quadtree.PointQuadTree;
...
//            mPoint = PROJECTION.toPoint(mPosition);
        ...
        public Point getPoint() {
            return PROJECTION.toPoint(mClusterItem.getPosition());
        }

        @Override
        public LatLng getPosition() {
            return mClusterItem.getPosition();
        }

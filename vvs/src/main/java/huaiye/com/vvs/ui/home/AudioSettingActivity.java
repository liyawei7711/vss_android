...
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_HD;
...
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_aec;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_agc;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_bitrate;
...
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_capturebianma;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_kbps;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_mPublishPresetoption;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_ns;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_player;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_playerjiema;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_qos;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_recapture;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_soft;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_tcp;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_trans;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_udp;
import static huaiye.com.vvs.common.AppUtils.STRING_KEY_ying;
import static huaiye.com.vvs.common.AppUtils.blackPhone;
...
//    @BindView(R.id.rg_use_encrypt)
//    RadioGroup rg_use_encrypt;
//
//    @BindView(R.id.rbt_use_encrypt_open)
//    RadioButton rbt_use_encrypt_open;
//
//    @BindView(R.id.rbt_use_encrypt_close)
//    RadioButton rbt_use_encrypt_close;
    ...
    protected void initActionBar() {
        getNavigate().setTitlText(getString(R.string.canshu_setting))
    ...
    public void doInitDelay() {
        ...
        if (blackPhone.contains(Build.MODEL)) {
            rbt_lvhd1080p.setVisibility(View.GONE);
        } else {
            rbt_lvhd1080p.setVisibility(View.VISIBLE);
        }
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    ...
                    case R.id.rbt_framerate_customer:
                        ...
                        SP.putInteger(STRING_KEY_mPublishPresetoption, -1);
                        seekbar_framerate.setProgress(SP.getInteger(STRING_KEY_bitrate, 0));
                        break;
                }
            }
        });
        ...
        seekbar_framerate.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                tv_framerate_num.setText((progress + min) * 8 + " " + STRING_KEY_kbps);
        ...
        rg_capture_qos.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                HYClient.getSdkOptions().Capture().setOpenQOS(SP.getInteger(STRING_KEY_qos, 0) == 1);
            }
        });
        ...
        rg_aec.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                SP.setParam(STRING_KEY_aec, HYClient.getSdkOptions().Capture().getAudioEnableAEC().value());
//                tv_arc_status.setText("当前AEC模式为: " + HYClient.getSdkOptions().Capture().getAudioEnableAEC().value());
        ...
        rg_agc.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                SP.setParam(STRING_KEY_agc, HYClient.getSdkOptions().Capture().getAudioEnableAGC().value());
//                tv_agc_status.setText("当前AGC模式为: " + HYClient.getSdkOptions().Capture().getAudioEnableAGC().value());
        ...
        rg_ns.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                SP.setParam(STRING_KEY_ns, HYClient.getSdkOptions().Capture().getAudioNS().value());
//                tv_ns_status.setText("当前NS模式为: " + HYClient.getSdkOptions().Capture().getAudioNS().value());
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.rbt_play_lvhd:
                        SP.setParam(STRING_KEY_player, STRING_KEY_HD);
                        break;
        ...
        if (TextUtils.isEmpty(SP.getParam(STRING_KEY_capturebianma, "").toString())) {
        ...
        if (SP.getParam(STRING_KEY_capturebianma, "").equals(STRING_KEY_ying)) {
    ...
    protected void onResume() {
        ...
        switch (SP.getInteger(STRING_KEY_mPublishPresetoption, -1)) {
            ...
            case -1:
                ...
                ll_seekbar.setVisibility(View.VISIBLE);
                seekbar_framerate.setProgress(SP.getInteger(STRING_KEY_bitrate, 0) - min);

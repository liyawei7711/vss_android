package huaiye.com.vvs.ui.meet.fragments;
...
import huaiye.com.vvs.ui.meet.viewholder.MemberLayoutHolder;
...
public class MeetMembersLayoutFragment extends AppBaseFragment {
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (bean.bean.nJoinStatus != 2) {
                            showToast(AppUtils.getString(R.string.user_not_attended));
                            return;
                        }
    ...
    private void changeVideoPage() {
        if (currentModel == null) {
            showToast(AppUtils.getString(R.string.change_user_empty));
            return;
        }
        if (currentView == null) {
            showToast(AppUtils.getString(R.string.change_local_empty));
            return;
        }
                ...
                .changeMeetingMemberLayout(SdkParamsCenter.Meet.UserSwap().setnMeetingID(nMeetID)
                        ...
                        new SdkCallback<CMeetingUserSwapRsp>() {
                            ...
                            public void onSuccess(CMeetingUserSwapRsp cGetMeetingInfoRsp) {
                                showToast(AppUtils.getString(R.string.change_is_success));
                                hideAll();
                            }
    ...
    private void changeSelectedView(View view, CheckBox cb) {
        if (view.getTag() != null) {
            ...
            showToast(AppUtils.getString(R.string.local_no_user));
        }
    }

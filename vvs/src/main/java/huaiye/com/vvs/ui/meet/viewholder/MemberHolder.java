...
public class MemberHolder extends LiteViewHolder {
    ...
    public MemberHolder(Context context, View view, View.OnClickListener ocl, Object obj) {
    ...
    public void bindData(Object holder, int position, Object data, int size, List datas, Object extr) {
        ...
        if (position == 0) {
            if (bean.nJoinStatus != 2) {
                tvTitle.setText(AppUtils.getString(R.string.weiruhui));
            } else {
                tvTitle.setText(AppUtils.getString(R.string.yiruhui));
            }
        ...
        if(bean.nJoinStatus == 0 || bean.nJoinStatus == 1 || bean.nJoinStatus == 3 || bean.nJoinStatus == 99) {
            ivChonghu.setImageResource(R.drawable.selector_chonghu_statue);
        } else if(bean.nJoinStatus == 4) {
            ivChonghu.setImageResource(R.drawable.ico_guauduan);
        }
    }
}

...
import static huaiye.com.vvs.common.AppUtils.audioDevice;
...
public class AppAudioManagerWrapper {
    ...
    public void start(){
        if (!audioDevice.contains(Build.MODEL) && audio == null) {
    ...
    private static void sameCallVolume(){
        AudioManager mAudioManager = (AudioManager) MCApp.getInstance().getSystemService(Context.AUDIO_SERVICE);

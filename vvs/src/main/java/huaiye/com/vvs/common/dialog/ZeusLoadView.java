...
public class ZeusLoadView extends Dialog {
    ...
    public ZeusLoadView(Context context) {
        ...
        handler = new Handler();
        loading_text = AppUtils.getString(R.string.reqing);
        success_text = AppUtils.getString(R.string.reqsuccess);
...
//        textView.setText(loading_text);
    ...
    public ZeusLoadView successText(String text) {
        success_text = TextUtils.isEmpty(text) ? AppUtils.getString(R.string.dealsuccess) : text;
        return this;
    }
    ...
    public void setLoading() {
        ...
        try {
            ...
            Logger.log("ZeusLoadView ERROR show "+e.toString());
        }
    }
    ...
    public void dismiss() {
        try {
            ...
            Logger.log("ZeusLoadView ERROR dismiss "+e.toString());
        }
    }
}

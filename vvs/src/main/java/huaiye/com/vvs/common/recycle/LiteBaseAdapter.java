package huaiye.com.vvs.common.recycle;
...
public class LiteBaseAdapter<T> extends RecyclerView.Adapter<LiteViewHolder> {
    ...
    public LiteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Class[] paramTypes = {Context.class, View.class, View.OnClickListener.class, Object.class};
        Object[] params = {context, view, ocl, obj}; // 方法传入的参数

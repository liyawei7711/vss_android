...
public class P2PUserListPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public P2PUserListPopupWindow(Context context) {
        super(context);
        ...
        View contentView = LayoutInflater.from(context).inflate(R.layout.popu_user_p2p_list, null);

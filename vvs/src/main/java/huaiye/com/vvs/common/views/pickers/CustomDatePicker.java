package huaiye.com.vvs.common.views.pickers;
...
public class CustomDatePicker {
    ...
    public interface ResultHandler {
        void handle(String time, long timelong);
    }
    ...
    private final String Temp = "yyyy-MM-dd HH:mm";
    private SimpleDateFormat sdf = new SimpleDateFormat(Temp, Locale.CHINA);
    ...
    private TextView tv_cancle, tv_select, tv_year, tv_month, tv_day, hour_text, minute_text;
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, long startDate, long endDate) {
        ...
        initParams(context, resultHandler, sdf.format(date1), sdf.format(date2));
    }

    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        initParams(context, resultHandler, startDate, endDate);
    }

    private void initParams(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        if (isValidDate(startDate, Temp) && isValidDate(endDate, Temp)) {
            canAccess = true;
    ...
    private void initView() {
        ...
        tv_month = (TextView) datePickerDialog.findViewById(R.id.tv_month);
        tv_day = (TextView) datePickerDialog.findViewById(R.id.tv_day);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(sdf.format(selectedCalender.getTime()), selectedCalender.getTimeInMillis());
                datePickerDialog.dismiss();
            }
        });
    }
    ...
    public CustomDatePicker showYear(boolean value) {
        if (value) {
    ...
    public CustomDatePicker showHour(boolean value) {
        if (value) {
    ...
    public CustomDatePicker showMint(boolean value) {
        if (value) {

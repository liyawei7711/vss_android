package huaiye.com.vvs.models.map;
...
import huaiye.com.vvs.models.map.bean.MarkBean;
...
public class MapApi {
    ...
    private MapApi() {
        URL = AppDatas.Constants().getAddressBaseURL() + "vss/httpjson/get_mark_list";
    }
    ...
    public void getMarket(MarkModelBean bean, final ModelCallback<MapMarkBean> callback) {
        URL = AppDatas.Constants().getAddressBaseURL() + "vss/httpjson/get_mark_info";
        Https.post(URL)
                .addHeader("X-Token", AppDatas.Auth().getToken())
    ...
    public void deleteMark(Observer<CommonResult> observer,final ArrayList<Integer> markIDs) {
        final String URL = AppDatas.Constants().getAddressBaseURL() + "vss/httpjson/del_mark";
    ...
    public void pushGps(GPSMapBean bean, final ModelCallback<Object> callback) {
        URL = AppDatas.Constants().getAddressBaseURL() + "vss/httpjson/push_gps_info";
